import type { Route } from "./+types/omelette";
import RecipeArticle from "../components/recipeArticle"
import HeaderImage from "/public/assets/images/image-omelette.jpeg"


export function meta({}: Route.MetaArgs) {
  return [
    { title: "Front-End Mentor -> Omelette Recipe" },
    { name: "description", content: "This is project 4 for front-end mentor assignment to practice design. It shows the creation of an omeltte recipe  " },
  ];
};

export default function Omelette() {
    return(
<RecipeArticle headerImgSrc={HeaderImage}  headerImgAlt="A finished omelette on a plate.">
